<x-app-layout>
    <section class="max-w-screen-xl mx-auto p-4">
        <a href="/summary" class="my-2"><span class="text-black">&#60;</span> Kembali ke menulis ringkasan</a>
        <form action="{{ route('book.metadata') }}" method="post" class="flex flex-col justify-evenly box-border h-3/6"
