    ...
    <section class="max-w-screen-xl mx-auto p-4">
        ...
        <article class="flex flex-col w-full">
            <div
                ...
                <img class="rounded-t-lg h-40 w-60 md:h-30 md:w-40 md:rounded-none md:rounded-s-lg p-3 lg:ml-4"
                    src="/storage/{{ $book->cover }}" alt="Gambar cover buku">
                ...
                <div class="flex flex-col h-36">
                    ...
                    <div class="leading-3">
                        ...
                        <p class="mb-3 font-regular text-gray-700 dark:text-gray-400">Terbit {{ $book->publication_year
                            }}</p>
            ...
            <div class="flex justify-end gap-4 items-end lg:mr-80">
                <button type="submit"
                    ...
                    <a href="/summary/input/{{$book_id}}/{{$summary_id}}">
                        Hapus
                    </a>
                </button>
        ...
        <article class="flex flex-col items-center">
            ...
            <div
                ...
                <div class="flex items-center gap-4">
                    <a href="/summary/edit/{{$book_id}}/{{$summary_id}}/{{$topic['id']}}"
