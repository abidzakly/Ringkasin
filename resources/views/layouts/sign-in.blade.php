            ...
            <form action="{{ route('login') }}" method="post" id="login">
                ...
                <div class="p-4 md:p-5 flex-col flex justify-center self-center">
                    <div class=" self-center">
                        ...
                        <x-input-form placeholder="Email" name="email" type="text" class="mb-[20px]"></x-input-form>
                        ...
                        <div>
                            <a href="#" class="hover:text-darkblue font-light">Lupa Password?</a>
                        </div>
                    </div>
                    <div class="flex flex-col justify-center items-center p-4 md:p-5 rounded-b">
                        ...
                        <p class="mt-[10px] font-medium">Belum punya akun?<a href="/register"
