  ...
  <nav class="bg-navpurple dark:bg-gray-900" id="navbar">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
      <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
        ...
        <span class="self-center text-xl lg:text-2xl font-semibold whitespace-nowrap dark:text-white">Ringkasin</span>
      </a>
      ...
      <ul class="hidden lg:flex end-0">
        <li class="mr-10">
          <a href="{{ route('eksplor') }}" class="hover:bg-blue-800 hover:duration-200 inline-block rounded-full px-1 py-1 bg-darkblue shadow-lg"><svg
        ...
        <li class="mr-12">
          <a href="{{route('summary.header')}}" class="hover:bg-blue-800 hover:duration-200 inline-block rounded-full px-1 py-1 bg-darkblue shadow-lg">
        ...
        <div id="dropdownInformation"
          ...
          <div class="px-4 py-3 bg-photo text-sm text-white">
            <img
              ...
              alt="Foto Profil" class="h-32 mx-2 py-4 px-4 rounded-full items-center">
          </div>
            ...
            <li>
              <a href="/balance"
                class="flex px-4 py-2 hover:bg-gray-100 hover:text-black dark:hover:bg-gray-600 dark:hover:text-white items-center"><span
                  class="material-symbols-outlined mr-2">account_balance_wallet</span>Dompet Saya</a>
            </li>
            <li>
              <a href="/profile-info"
                class="flex px-4 py-2 hover:bg-gray-100 hover:text-black dark:hover:bg-gray-600 dark:hover:text-white items-center"><span
      ...
      <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="navbar-language">
        <ul
          ...
          <li class="lg:hidden">
            <a href="#"
              class="block py-2 px-3 lg:hidden text-gray-900 rounded hover:bg-gray-100 dark:text-white ">Write Summary</a>
          </li>
        </ul>
      </div>
